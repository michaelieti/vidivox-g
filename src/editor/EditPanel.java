...
public class EditPanel extends Stage {
	...
	public EditPanel(MediaView mv, String title) {
		...
		mp3 = new Mp3Tab(mv, "Mp3", "Overlay an mp3 or wav file on the current video. The overlay will apply to the entire video from the time point the video is currently at.");
