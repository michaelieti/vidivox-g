...
public class MediaFormatter {
	...
	/**
	 * Checks if a media located at a URI object is acceptable to be played by
	 * JavaFX's MediaPlayer and its related components.
	 * 
	 * @param mediaPath
	 *            - a URI object pointing to the media to be transformed
	...
	/**
	 * Takes a media file at the specified URI and transforms it to a specified
	 * file.
	 * 
	 * @param mediaPath
	 *            - a URI object to be transformed
	 * @param mediaType
	 *            - MediaFormatter.MP4 or MediaFormatter.FLV
